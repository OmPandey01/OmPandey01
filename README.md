...
#### [Scoall.in](https://scoall.in)
*A production-grade sports management and networking platform.*
* **Stack:** PERN (PostgreSQL, Express, React, Node.js), Redis
* **Focus:** Real-time ball-by-ball scoring modules, scalable social feeds, and tournament management architecture.

#### **Sparx (Inspirations)**
*A cross-platform mobile application designed for creative friction and idea capture.*
* **Stack:** React Native, WatermelonDB, SQLite
* **Focus:** High-performance local data persistence and multi-format reference storage for creators.
